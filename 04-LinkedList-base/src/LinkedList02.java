 ...
 * 主要方法：
 * 1.获取链表中元素个数
 * 2.添加元素：头 O(1)--因为有头结点 尾 O(n)---需要从头到尾遍历所有节点 中间 O(n)
 * 3.修改元素：头 O(1)--因为有头结点 尾 O(n)---需要从头到尾遍历所有节点 中间 O(n)
 * 4.删除元素：头 O(1)--因为有头结点 尾 O(n)---需要从头到尾遍历所有节点 中间 O(n)
 * 5.查找元素：头 O(1)--因为有头结点 尾 O(n)---需要从头到尾遍历所有节点 中间 O(n)
